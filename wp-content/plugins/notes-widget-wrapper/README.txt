...
Tags: sticky note, note, widget, style
...
Notes Widget Wrapper PRO offers the following additional features:

* Default Shortcode Settings
* Shortcodes
* Use note wrappers in posts, pages, and other post types (not just widget areas)
* Ability to remove all Web Rockstar branding and callouts in WordPress admin

[youtube https://www.youtube.com/watch?v=vqICtJKNS6M&t=22s]

[Get Notes Widget Wrapper PRO](http://webrockstar.net/downloads/notes-widget-wrapper-pro?utm_source=notes-widget-wrapper-directory&utm_medium=plugin-description)
...
[youtube https://www.youtube.com/watch?v=eEMQzCt7DVs&feature=youtu.be]
...
You can download [Notes Widget Wrapper PRO]('https://webrockstar.net/downloads/notes-widget-wrapper-pro/') at webrockstar.net. 

== Screenshots ==

1. Example 1: front end post rendering
2. Example 1: back end post content and shortcode
3. Example 2: front end post rendering
4. Example 2: back end content and shortcode
5. Example 3: front end post rendering
6. Example 3: back end content and shortcode
7. The shortcode editor modal window. Configure your shortcode as desired.
8. These are the settings available on the widget administration page. The built in "Text" and "Custom HTML" widgets work great with Notes Widget Wrapper.
9. This is how the widget configuration in screenshot 1 looks on the front end. The note content is quite long to demonstrate the range of styling that is available.
