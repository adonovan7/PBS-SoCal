        ...
        if ( current_user_can( 'buddyforms_' . $form_slug . '_edit' ) ) {
            ...
            if ( isset( $buddyforms[$form_slug]['edit_link'] ) && $buddyforms[$form_slug]['edit_link'] != 'none' ) {
                ...
                echo  apply_filters(
                    ...
                    buddyforms_edit_post_link( '<span aria-label="' . __( 'Edit', 'buddyforms' ) . '" class="dashicons dashicons-edit"></span> ' . __( 'Edit', 'buddyforms' ) . '' ),
                    get_the_ID(),
                    $form_slug
                ) ;
            }
...
function buddyforms_metabox_go_pro()
{
    buddyforms_go_pro(
        '<span></span>',
        '',
        array( 'Priority Support', 'More Form Elements', 'More Options' ),
        false
    );
    buddyforms_go_pro(
        '<span></span>',
    ...
    buddyforms_go_pro(
        ...
        array( 'Manage User Roles', 'Manage Capabilities', 'More Validation Options' ),
        false
    );
    buddyforms_go_pro(
        '<span></span>',
